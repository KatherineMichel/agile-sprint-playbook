...
Needs, Wants, Desires is a [Card Sorting](https://github.com/thoughtbot/design-sprint/blob/master/Exercises/card-sorting.md)
...
It is best to reflect on the [Problem Statement](https://github.com/thoughtbot/design-sprint/blob/master/Exercises/problem-statement.md)
while doing this.
